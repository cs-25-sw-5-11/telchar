...
def test_unit_file_already_cleaned_returns_true_for_existing_file():
    ...
    assert file_already_cleaned("some_input_dir/temp_file.csv", "temp_cleaned_dir") == True
...
def test_unit_file_already_cleaned_returns_false_for_nonexisting_file():
    ...
    assert file_already_cleaned("some_input_dir/nonexistent_file.csv", "temp_cleaned_dir_empty") == False
